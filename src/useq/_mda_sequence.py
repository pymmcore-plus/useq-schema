...
class MDASequence(UseqModel):
    ...
    grid_plan : GridFromCorners, GridRelative, NoTile
        The grid plan to follow. One of `GridFromCorners`, `GridRelative` or `NoTile`.
    ...
    def iter_axis(
        self, axis: str
    ) -> Iterator[Union[Position, Channel, float, GridPosition]]:
        ...
        yield from {
            ...
            GRID: self.grid_plan.iter_grid_pos(self._fov_size[0], self._fov_size[1]),
        }[axis]
