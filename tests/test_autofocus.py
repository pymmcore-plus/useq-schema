...
from useq import AcquireImage, AxesBasedAF, HardwareAutofocus, MDASequence, NoAF
...
def _assert_autofocus(
    ...
    for idx, e in enumerate(sequence):
        ...
        if idx in expected_event_indexes:
            ...
            assert isinstance(action, AcquireImage)
...
mdas = [
    ...
    ("tpgcz", ("c",), ["DAPI", "FITC"], [{"z": 30}], {"range": 2, "step": 1}, {}, {}, (0, 4)),  # noqa: E501
    ("tpgzc", ("c",), ["DAPI", "FITC"], [{"z": 30}], {"range": 2, "step": 1}, {}, {}, tuple(range(0, 12, 2))),  # noqa: E501
    ("tpgcz", ("z",), ["DAPI", "FITC"], [{"z": 30}], {"range": 2, "step": 1}, {}, {}, tuple(range(0, 13, 2))),  # noqa: E501
    ("tpgzc", ("z",), ["DAPI", "FITC"], [{"z": 30}], {"range": 2, "step": 1}, {}, {}, (0, 3, 6)),  # noqa: E501
    ("tpgcz", ("g",), ["DAPI", "FITC"], [{"z": 30}], {}, {"rows": 2, "columns": 1}, {}, (0, 3)),  # noqa: E501
    ("tpgcz", ("g",), ["DAPI", "FITC"], [{"z": 30}, {"z": 20}], {}, {}, {}, ()),  # noqa: E501
    ("tpgcz", ("g",), ["DAPI", "FITC"], [{"z": 30}, {"z": 200}], {}, {"rows": 2, "columns": 1}, {}, (0, 3, 6, 9)),  # noqa: E501
    ("tpgcz", ("p",), ["DAPI", "FITC"], [{"z": 30}, {"z": 200}], {}, {"rows": 2, "columns": 1}, {}, (0, 5)),  # noqa: E501
    ("tpgcz", ("t",), ["DAPI", "FITC"], [{"z": 30}, {"z": 200}], {}, {}, {"interval": 1, "loops": 2}, (0, 5)),  # noqa: E501
    ("tpgcz", ("t", "p"), ["DAPI", "FITC"], [{"z": 30}, {"z": 200}], {}, {}, {"interval": 1, "loops": 2}, (0, 3, 6, 9)),  # noqa: E501
]
...
def test_autofocus(
    ...
    mda = MDASequence(
        ...
        grid_plan=gplan,
        time_plan=tplan,
        autofocus_plan=AxesBasedAF(autofocus_device_name="Z", autofocus_motor_offset=40, axes=axis)  # noqa: E501
    )
...
def _af_seq(axis: tuple[str, ...] | None, gplan: bool = False, zplan: bool = False, tplan: bool = False):  # noqa: E501
    ...
    af = {
            "autofocus_plan": AxesBasedAF(autofocus_device_name="Z", autofocus_motor_offset=np.random.randint(1, 100), axes=axis)  # noqa: E501
            if axis else NoAF()
        }
...
# order, af axis, channels, pos_plan, z_plan, grid_plan, time_plan, expected_af_event_indexes  # noqa: E501
mdas = [
    ("tpgcz", (), ["DAPI", "FITC"], [{"z": 30}, {"z": 10, "sequence": _af_seq(("c",))}], {}, {}, {}, (2, 4)),  # noqa: E501
    ("tpgcz", (), ["DAPI", "FITC"], [{"z": 30}, {"z": 10, "sequence": _af_seq(("g",))}], {}, {}, {}, ()),  # noqa: E501
    ("tpgcz", (), ["DAPI", "FITC"], [{"z": 30}, {"z": 10, "sequence": _af_seq(("g",))}], {}, {"rows": 2, "columns": 1}, {}, (4, 7)),  # noqa: E501
    ("tpgcz", (), ["DAPI", "FITC"], [{"z": 30}, {"z": 10, "sequence": _af_seq(("p",))}], {}, {"rows": 2, "columns": 1}, {}, (4,)),  # noqa: E501
    ("tpgcz", (), ["DAPI", "FITC"], [{"z": 30}, {"z": 10, "sequence": _af_seq(("c",))}], {}, {"rows": 2, "columns": 1}, {}, (4, 6, 8, 10)),  # noqa: E501
    ("tpgcz", (), ["DAPI", "FITC"], [{"z": 30}, {"z": 10, "sequence": _af_seq(("c",))}], {"range": 2, "step": 1}, {}, {}, (6, 10)),  # noqa: E501
    ("tpgcz", (), ["DAPI", "FITC"], [{"z": 30}, {"z": 10, "sequence": _af_seq(("z",))}], {"range": 2, "step": 1}, {}, {}, (tuple(range(6, 17, 2)))),  # noqa: E501
...
def test_autofocus_sub_sequence(order: str, axis: tuple[str, ...], ch: list, pplan: list, zplan: dict, gplan: dict, tplan: dict, expected_event_indexes: int):  # noqa: E501
    ...
    if axis:
        af_plan = AxesBasedAF(autofocus_device_name="Z", autofocus_motor_offset=50, axes=axis)  # noqa: E501
    else:
        af_plan = NoAF()
